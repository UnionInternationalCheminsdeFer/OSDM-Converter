...
/**
 * This is the item provider adapter for a {@link Gtm.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider 
	...
	protected void addAccuracyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_accuracy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_accuracy_feature", "_UI_Edge_type"),
				 GtmPackage.Literals.EDGE__ACCURACY,
				 true,
				 false,
				 false,
	...
	protected void addLongitudePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_longitude_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_longitude_feature", "_UI_Edge_type"),
				 GtmPackage.Literals.EDGE__LONGITUDE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addLatitudePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_latitude_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_latitude_feature", "_UI_Edge_type"),
				 GtmPackage.Literals.EDGE__LATITUDE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		GeoSystem labelValue = ((Edge)object).getSystem();
