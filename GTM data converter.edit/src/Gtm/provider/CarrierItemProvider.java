...
/**
 * This is the item provider adapter for a {@link Gtm.Carrier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CarrierItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Carrier_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Carrier_code_feature", "_UI_Carrier_type"),
				 GtmPackage.Literals.CARRIER__CODE,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Carrier_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Carrier_name_feature", "_UI_Carrier_type"),
				 GtmPackage.Literals.CARRIER__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
