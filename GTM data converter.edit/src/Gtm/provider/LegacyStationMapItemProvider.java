...
/**
 * This is the item provider adapter for a {@link Gtm.LegacyStationMap} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LegacyStationMapItemProvider 
	 ...
	 * @generated
	 */
	public LegacyStationMapItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LegacyStationMap_legacyCode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LegacyStationMap_legacyCode_feature", "_UI_LegacyStationMap_type"),
				 GtmPackage.Literals.LEGACY_STATION_MAP__LEGACY_CODE,
				 true,
				 false,
				 false,
	...
	protected void addStationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LegacyStationMap_station_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LegacyStationMap_station_feature", "_UI_LegacyStationMap_type"),
				 GtmPackage.Literals.LEGACY_STATION_MAP__STATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LegacyStationMap"));
	}
	...
	public String getText(Object object) {
		LegacyStationMap legacyStationMap = (LegacyStationMap)object;
		return getString("_UI_LegacyStationMap_type") + " " + legacyStationMap.getLegacyCode();
	}
