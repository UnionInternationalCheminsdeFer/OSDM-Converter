...
/**
 * This is the item provider adapter for a {@link Gtm.ReservationParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReservationParameterItemProvider 
	 ...
	 * @generated
	 */
	public ReservationParameterItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GtmPackage.Literals.RESERVATION_PARAMETER__PARAMS9181);
			childrenFeatures.add(GtmPackage.Literals.RESERVATION_PARAMETER__OPTIONS);
		}
	...
	/**
	 * This returns ReservationParameter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReservationParameter"));
	}
	...
	public String getText(Object object) {
		String label = ((ReservationParameter)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ReservationParameter_type") :
			getString("_UI_ReservationParameter_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GtmPackage.Literals.RESERVATION_PARAMETER__PARAMS9181,
				 GtmFactory.eINSTANCE.createReservationParams9181()));

		newChildDescriptors.add
			(createChildParameter
				(GtmPackage.Literals.RESERVATION_PARAMETER__OPTIONS,
				 GtmFactory.eINSTANCE.createReservationOptions()));
	}
