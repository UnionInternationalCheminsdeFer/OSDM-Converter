...
/**
 * This is the item provider adapter for a {@link Gtm.IncludedFreePassengerLimit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IncludedFreePassengerLimitItemProvider 
	 ...
	 * @generated
	 */
	public IncludedFreePassengerLimitItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IncludedFreePassengerLimit_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IncludedFreePassengerLimit_number_feature", "_UI_IncludedFreePassengerLimit_type"),
				 GtmPackage.Literals.INCLUDED_FREE_PASSENGER_LIMIT__NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addPassengerConstraintPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IncludedFreePassengerLimit_passengerConstraint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IncludedFreePassengerLimit_passengerConstraint_feature", "_UI_IncludedFreePassengerLimit_type"),
				 GtmPackage.Literals.INCLUDED_FREE_PASSENGER_LIMIT__PASSENGER_CONSTRAINT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns IncludedFreePassengerLimit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IncludedFreePassengerLimit"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IncludedFreePassengerLimit.class)) {
