...
/**
 * This is the item provider adapter for a {@link Gtm.RegionalConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionalConstraintItemProvider 
	 ...
	 * @generated
	 */
	public RegionalConstraintItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RegionalConstraint_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RegionalConstraint_id_feature", "_UI_RegionalConstraint_type"),
				 GtmPackage.Literals.REGIONAL_CONSTRAINT__ID,
				 true,
				 false,
				 false,
	...
	protected void addDistancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RegionalConstraint_distance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RegionalConstraint_distance_feature", "_UI_RegionalConstraint_type"),
				 GtmPackage.Literals.REGIONAL_CONSTRAINT__DISTANCE,
				 true,
				 false,
				 false,
	...
	protected void addDataDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RegionalConstraint_dataDescription_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RegionalConstraint_dataDescription_feature", "_UI_RegionalConstraint_type"),
				 GtmPackage.Literals.REGIONAL_CONSTRAINT__DATA_DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns RegionalConstraint.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RegionalConstraint"));
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(GtmPackage.Literals.REGIONAL_CONSTRAINT__REGIONAL_VALIDITY,
				 GtmFactory.eINSTANCE.createRegionalValidity()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == GtmPackage.Literals.REGIONAL_CONSTRAINT__ENTRY_CONNECTION_POINT ||
			childFeature == GtmPackage.Literals.REGIONAL_CONSTRAINT__EXIT_CONNECTION_POINT;
