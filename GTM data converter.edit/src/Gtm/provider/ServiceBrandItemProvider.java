...
/**
 * This is the item provider adapter for a {@link Gtm.ServiceBrand} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceBrandItemProvider 
	 ...
	 * @generated
	 */
	public ServiceBrandItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceBrand_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceBrand_code_feature", "_UI_ServiceBrand_type"),
				 GtmPackage.Literals.SERVICE_BRAND__CODE,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceBrand_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceBrand_name_feature", "_UI_ServiceBrand_type"),
				 GtmPackage.Literals.SERVICE_BRAND__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAbbreviationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceBrand_abbreviation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceBrand_abbreviation_feature", "_UI_ServiceBrand_type"),
				 GtmPackage.Literals.SERVICE_BRAND__ABBREVIATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceBrand_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceBrand_description_feature", "_UI_ServiceBrand_type"),
				 GtmPackage.Literals.SERVICE_BRAND__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ServiceBrand"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_ServiceBrand_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ServiceBrand.class)) {
