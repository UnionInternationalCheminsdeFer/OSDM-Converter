...
/**
 * This is the item provider adapter for a {@link Gtm.Text} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_id_feature", "_UI_Text_type"),
				 GtmPackage.Literals.TEXT__ID,
				 true,
				 false,
				 false,
	...
	protected void addTextUTF8PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_textUTF8_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_textUTF8_feature", "_UI_Text_type"),
				 GtmPackage.Literals.TEXT__TEXT_UTF8,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTextICAOPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_textICAO_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_textICAO_feature", "_UI_Text_type"),
				 GtmPackage.Literals.TEXT__TEXT_ICAO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addShortTextUTF8PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_shortTextUTF8_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_shortTextUTF8_feature", "_UI_Text_type"),
				 GtmPackage.Literals.TEXT__SHORT_TEXT_UTF8,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addShortTextICAOPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_shortTextICAO_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_shortTextICAO_feature", "_UI_Text_type"),
				 GtmPackage.Literals.TEXT__SHORT_TEXT_ICAO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GtmPackage.Literals.TEXT__TRANSLATIONS);
		}
	...
	public String getText(Object object) {
		String label = ((Text)object).getTextUTF8();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GtmPackage.Literals.TEXT__TRANSLATIONS,
				 GtmFactory.eINSTANCE.createTranslation()));
	}
