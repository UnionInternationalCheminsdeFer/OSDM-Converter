...
public class LegacyExporter {
	...
	private String getHeaderLine(String fileName, String provider, String providerName, int size, Date startDate, Date endDate) {
		...
		// 	1 Code of the supplier RU numeric 4 M TAP TSI Technical Document B.8 1-4 e.g. 0081 for �BB 
		sb.append(String.format("%4s", provider));   //$NON-NLS-1$
		//	2 Shortened name of the supplier RU alpha numeric 30 M  5-34 e.g. �BB
	...
	private void addStrings(StringBuilder sb, String text) {
		if (text == null) {
