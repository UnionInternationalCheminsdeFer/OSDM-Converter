...
import gtmV30.AfterSalesConditionDef;
import gtmV30.AfterSalesRuleDef;
import gtmV30.AllowedChange;
import gtmV30.BarCodeTypesDef;
import gtmV30.CalendarDef;
import gtmV30.CarrierConstraintDef;
import gtmV30.CarrierResourceLocationDef;
import gtmV30.CombinationConstraint;
import gtmV30.ConnectionPointDef;
import gtmV30.ControlSecurityTypeDef;
import gtmV30.CrossBorderConditionDef;
import gtmV30.CurrencyPriceDef;
import gtmV30.ExcludedTimeRange;
import gtmV30.FareCombinationConstraintDef;
import gtmV30.FareCombinationModelDef;
import gtmV30.FareConstraintBundle;
import gtmV30.FareConstraintBundle.FareTypeDef;
import gtmV30.FareDataDef;
import gtmV30.FareDef;
import gtmV30.FareDelivery;
import gtmV30.FareDeliveryDef;
import gtmV30.FareDeliveryDetailsDef;
import gtmV30.FareDeliveryDetailsDef.Usage;
import gtmV30.FareReferenceStationSet;
import gtmV30.FareReferenceStationSetDef;
import gtmV30.FareResourceLocationDef;
import gtmV30.FulfillmentConstraintDef;
import gtmV30.GeoCoordinate;
import gtmV30.IncludedFreePassenger;
import gtmV30.LegacyAccountingIdentifierDef;
import gtmV30.LegacyReservationParameterDef;
import gtmV30.LineDef;
import gtmV30.LuggageConstraint;
import gtmV30.LuggageRestriction;
import gtmV30.OnlineResourceDef;
import gtmV30.PassengerCombinationConstraintDef;
import gtmV30.PassengerConstraintDef;
import gtmV30.PersonalDataConstraintDef;
import gtmV30.PolygonDef;
import gtmV30.PriceDef;
import gtmV30.ReductionCardDef;
import gtmV30.ReductionCardReferenceDef;
import gtmV30.ReductionConstraintDef;
import gtmV30.RegionalConstraintDef;
import gtmV30.RegionalValidityDef;
import gtmV30.RelativeTimeDef;
import gtmV30.RequiredDatum;
import gtmV30.RequiredSi;
import gtmV30.ReservationOptionGroupDef;
import gtmV30.ReservationParameterDef;
import gtmV30.ReservationOptions;
import gtmV30.ReturnConstraint;
import gtmV30.SalesAvailabilityConstraintDef;
import gtmV30.ServiceClassDefinitionDef;
import gtmV30.ServiceClassDefinitionDef.ComfortClassDef;
import gtmV30.ServiceClassDefinitionDef.ServiceClassIdDef;
import gtmV30.ServiceClassDefinitionDef.TravelClassDef;
import gtmV30.ServiceConstraintDef;
import gtmV30.ServiceLevelDef;
import gtmV30.StationDef;
import gtmV30.StationNamesDef;
import gtmV30.StationResourceLocationDef;
import gtmV30.TextDef;
import gtmV30.RelativeTimeDef.TimeUnit;
import gtmV30.TrainResourceLocationDef;
import gtmV30.Transfer;
import gtmV30.TranslationDef;
import gtmV30.TravelValidityConstraintDef;
import gtmV30.TripAllocationConstraintDef;
import gtmV30.TripInterruptionConstraintDef;
import gtmV30.ValidityRange.TimeUnitDef;
import gtmV30.VatDetailDef;
import gtmV30.VatDetailDef.VatScopeDef;
import gtmV30.ViaStationsDef;
import gtmV30.ZoneDef;
import gtmV30.ZoneDefinitionDef;



public class GtmJsonExporterV30 {
	...
	public GtmJsonExporterV30 () {	}

	public GtmJsonExporterV30 (GeneralTariffModel gtm) {
		this.gtm = gtm;
	}
	...
	private List<LuggageConstraint> convertLuggageConstraints(LuggageConstraints lcs) {
		...
		for (Gtm.LuggageConstraint lc : lcs.getConstraints()) {
			...
			if (lc.getRestrictedItems() != null && !lc.getRestrictedItems().isEmpty()) {
				...
				jlc.setRestrictedLuggageItems(new ArrayList<gtmV30.LuggageRestriction>());
	...
	private LuggageRestriction convert(LuggageItemsRestriction lir) {
		...
		if (lir.getDimension() != null && !lir.getDimension().isEmpty()) {
			...
			jlr.setRestrictions(new ArrayList<gtmV30.LuggageDimension>());
	...
	private gtmV30.LuggageDimension convert(LuggageDimension ld) {
		
		gtmV30.LuggageDimension jld = new gtmV30.LuggageDimension();
	...
	private gtmV30.LuggageDimension.Dimension convert(Dimension dimension) {
		
		if (dimension == null) return null;
		
		if (dimension.equals(Dimension.WEIGHT)) {
			return gtmV30.LuggageDimension.Dimension.WEIGHT;
		} else if (dimension.equals(Dimension.WEIGHT)) {
			return gtmV30.LuggageDimension.Dimension.VOLUME;
		} else if (dimension.equals(Dimension.VOLUME)) {
			return gtmV30.LuggageDimension.Dimension.HEIGHT;
		} else if (dimension.equals(Dimension.HEIGHT)) {
			return gtmV30.LuggageDimension.Dimension.WIDTH;
		} else if (dimension.equals(Dimension.WIDTH)) {
			return gtmV30.LuggageDimension.Dimension.LENGTH;
		} else if (dimension.equals(Dimension.LENGTH)) {
			return gtmV30.LuggageDimension.Dimension.WIDTH_HEIGHT;
		} else if (dimension.equals(Dimension.WIDTH_LENGTH_HEIGHT)) {
			return gtmV30.LuggageDimension.Dimension.WIDTH_HEIGHT_LENGTH;
		} 
	...
	private TravelValidityConstraintDef convertToJson(TravelValidityConstraint tv) {
		...
		if (tv.getRange() != null) {
			 ...
			 gtmV30.ValidityRange range = convertToJson(tv.getRange());
			 if (range != null) {
	...
	private gtmV30.ValidityRange convertToJson(ValidityRange r) {
		if (r == null) return null;
		
		gtmV30.ValidityRange jr = new gtmV30.ValidityRange();
	...
	private static SalesAvailabilityConstraintDef convertToJson(SalesAvailabilityConstraint sa) {
		...
		if (sa.getRestrictions() != null && !sa.getRestrictions().isEmpty()) {
			...
			ArrayList<gtmV30.SalesRestriction> listJ = new ArrayList<gtmV30.SalesRestriction>();
	...
	private static gtmV30.SalesRestriction convertToJson(SalesRestriction r) {
		if (r == null) return null;
		gtmV30.SalesRestriction rJ = new gtmV30.SalesRestriction();
