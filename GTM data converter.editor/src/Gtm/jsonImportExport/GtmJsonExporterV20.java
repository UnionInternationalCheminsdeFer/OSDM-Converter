...
import gtmV20.AfterSalesConditionDef;
import gtmV20.AfterSalesRuleDef;
import gtmV20.AllowedChange;
import gtmV20.BarCodeTypesDef;
import gtmV20.CalendarDef;
import gtmV20.CarrierConstraintDef;
import gtmV20.CarrierResourceLocationDef;
import gtmV20.CombinationConstraint;
import gtmV20.ConnectionPointDef;
import gtmV20.ControlSecurityTypeDef;
import gtmV20.CrossBorderConditionDef;
import gtmV20.CurrencyPriceDef;
import gtmV20.ExcludedTimeRange;
import gtmV20.FareCombinationConstraintDef;
import gtmV20.FareCombinationModelDef;
import gtmV20.FareConstraintBundle;
import gtmV20.FareConstraintBundle.FareTypeDef;
import gtmV20.FareDeliveryDetailsDef.Usage;
import gtmV20.FareDataDef;
import gtmV20.FareDef;
import gtmV20.FareDelivery;
import gtmV20.FareDeliveryDef;
import gtmV20.FareDeliveryDetailsDef;
import gtmV20.FareReferenceStationSet;
import gtmV20.FareReferenceStationSetDef;
import gtmV20.FareResourceLocationDef;
import gtmV20.FulfillmentConstraintDef;
import gtmV20.GeoCoordinate;
import gtmV20.IncludedFreePassenger;
import gtmV20.LegacyAccountingIdentifierDef;
import gtmV20.LegacyReservationParameterDef;
import gtmV20.LineDef;
import gtmV20.LuggageConstraint;
import gtmV20.LuggageRestriction;
import gtmV20.OnlineResourceDef;
import gtmV20.PassengerCombinationConstraintDef;
import gtmV20.PassengerConstraintDef;
import gtmV20.PersonalDataConstraintDef;
import gtmV20.PolygonDef;
import gtmV20.PriceDef;
import gtmV20.ReductionCardDef;
import gtmV20.ReductionCardReferenceDef;
import gtmV20.ReductionConstraintDef;
import gtmV20.RegionalConstraintDef;
import gtmV20.RegionalValidityDef;
import gtmV20.RegulatoryConditionsDef;
import gtmV20.RelativeTimeDef;
import gtmV20.RelativeTimeDef.TimeUnit;
import gtmV20.RequiredDatum;
import gtmV20.RequiredSi;
import gtmV20.ReservationOptionGroupDef;
import gtmV20.ReservationOptions;
import gtmV20.ReservationParameterDef;
...
import gtmV20.StationDef;
import gtmV20.StationNamesDef;
import gtmV20.StationResourceLocationDef;
import gtmV20.TextDef;
import gtmV20.TrainResourceLocationDef;
import gtmV20.Transfer;
import gtmV20.TranslationDef;
import gtmV20.TravelValidityConstraintDef;
import gtmV20.TripAllocationConstraintDef;
import gtmV20.TripInterruptionConstraintDef;
import gtmV20.ValidityRange.TimeUnitDef;
import gtmV20.VatDetailDef;
import gtmV20.VatDetailDef.VatScopeDef;
import gtmV20.ViaStationsDef;
import gtmV20.ZoneDef;
import gtmV20.ZoneDefinitionDef;

public class GtmJsonExporterV20 {
	...
	public GtmJsonExporterV20 () {	}

	public GtmJsonExporterV20 (GeneralTariffModel gtm) {
		this.gtm = gtm;
	}
	...
	private List<LuggageConstraint> convertLuggageConstraints(LuggageConstraints lcs) {
		...
		for (Gtm.LuggageConstraint lc : lcs.getConstraints()) {
			...
			if (lc.getRestrictedItems() != null && !lc.getRestrictedItems().isEmpty()) {
				...
				jlc.setRestrictedLuggageItems(new ArrayList<gtmV20.LuggageRestriction>());
	...
	private LuggageRestriction convert(LuggageItemsRestriction lir) {
		...
		if (lir.getDimension() != null && !lir.getDimension().isEmpty()) {
			...
			jlr.setRestrictions(new ArrayList<gtmV20.LuggageDimension>());
	...
	private gtmV20.LuggageDimension convert(LuggageDimension ld) {
		
		gtmV20.LuggageDimension jld = new gtmV20.LuggageDimension();
	...
	private gtmV20.LuggageDimension.Dimension convert(Dimension dimension) {
		
		if (dimension == null) return null;
		
		if (dimension.equals(Dimension.WEIGHT)) {
			return gtmV20.LuggageDimension.Dimension.WEIGHT;
		} else if (dimension.equals(Dimension.WEIGHT)) {
			return gtmV20.LuggageDimension.Dimension.VOLUME;
		} else if (dimension.equals(Dimension.VOLUME)) {
			return gtmV20.LuggageDimension.Dimension.HEIGHT;
		} else if (dimension.equals(Dimension.HEIGHT)) {
			return gtmV20.LuggageDimension.Dimension.WIDTH;
		} else if (dimension.equals(Dimension.WIDTH)) {
			return gtmV20.LuggageDimension.Dimension.LENGTH;
		} else if (dimension.equals(Dimension.LENGTH)) {
			return gtmV20.LuggageDimension.Dimension.WIDTH_HEIGHT;
		} else if (dimension.equals(Dimension.WIDTH_LENGTH_HEIGHT)) {
			return gtmV20.LuggageDimension.Dimension.WIDTH_HEIGHT_LENGTH;
		} 
	...
	private TravelValidityConstraintDef convertToJson(TravelValidityConstraint tv) {
		...
		if (tv.getRange() != null) {
			 ...
			 gtmV20.ValidityRange range = convertToJson(tv.getRange());
			 if (range != null) {
	...
	private gtmV20.ValidityRange convertToJson(ValidityRange r) {
		if (r == null) return null;
		
		gtmV20.ValidityRange jr = new gtmV20.ValidityRange();
	...
	private static SalesAvailabilityConstraintDef convertToJson(SalesAvailabilityConstraint sa) {
		...
		if (sa.getRestrictions() != null && !sa.getRestrictions().isEmpty()) {
			...
			ArrayList<gtmV20.SalesRestriction> listJ = new ArrayList<gtmV20.SalesRestriction>();
	...
	private static gtmV20.SalesRestriction convertToJson(SalesRestriction r) {
		if (r == null) return null;
		gtmV20.SalesRestriction rJ = new gtmV20.SalesRestriction();
	...
	private static FareDef convertToJson(FareElement fare) {
		...
		if (fare.getRegulatoryConditions() != null && !fare.getRegulatoryConditions().isEmpty()) {
			...
			for (RegulatoryCondition r : fare.getRegulatoryConditions()) {
				...
				RegulatoryConditionsDef rj = RegulatoryConditionsDef.fromValue(r.getName());
				fareJ.getRegulatoryConditions().add(rj);
