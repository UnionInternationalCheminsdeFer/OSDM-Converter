...
public class OsdmOfflineV310Draft {
    ...
    public String toString() {
        ...
        sb.append(OsdmOfflineV310Draft.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OsdmOfflineV310Draft) == false) {
            return false;
        }
        OsdmOfflineV310Draft rhs = ((OsdmOfflineV310Draft) other);
