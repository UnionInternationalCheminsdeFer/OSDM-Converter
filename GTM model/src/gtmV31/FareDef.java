...
public class FareDef {
    ...
    private gtmV31.FareConstraintBundle.FareTypeDef fareType;
    /**
     ...
     */
    @JsonProperty("fareType")
    public gtmV31.FareConstraintBundle.FareTypeDef getFareType() {
        return fareType;
    }
     ...
     */
    @JsonProperty("fareType")
    public void setFareType(gtmV31.FareConstraintBundle.FareTypeDef fareType) {
