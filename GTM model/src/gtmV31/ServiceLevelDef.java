...
public class ServiceLevelDef {
    ...
    private List<gtmV31.ServiceClassDefinitionDef.ServiceClassIdDef> combiningServiceClassIds = new ArrayList<gtmV31.ServiceClassDefinitionDef.ServiceClassIdDef>();
    /**
     ...
     */
    @JsonProperty("combiningServiceClassIds")
    public List<gtmV31.ServiceClassDefinitionDef.ServiceClassIdDef> getCombiningServiceClassIds() {
     ...
     */
    @JsonProperty("combiningServiceClassIds")
    public void setCombiningServiceClassIds(List<gtmV31.ServiceClassDefinitionDef.ServiceClassIdDef> combiningServiceClassIds) {
