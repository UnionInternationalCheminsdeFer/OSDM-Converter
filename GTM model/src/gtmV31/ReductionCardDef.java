...
public class ReductionCardDef {
    ...
    private List<gtmV31.ServiceClassDefinitionDef.ServiceClassIdDef> serviceClasses = new ArrayList<gtmV31.ServiceClassDefinitionDef.ServiceClassIdDef>();
    /**
     ...
     */
    @JsonProperty("serviceClasses")
    public List<gtmV31.ServiceClassDefinitionDef.ServiceClassIdDef> getServiceClasses() {
     ...
     */
    @JsonProperty("serviceClasses")
    public void setServiceClasses(List<gtmV31.ServiceClassDefinitionDef.ServiceClassIdDef> serviceClasses) {
