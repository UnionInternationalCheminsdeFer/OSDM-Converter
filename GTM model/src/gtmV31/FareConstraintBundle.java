...
public class FareConstraintBundle {
    ...
    private List<String> defaultRegulatoryConditions = new ArrayList<String>();
    @JsonProperty("defaultLuggageConstraintRef")
    private String defaultLuggageConstraintRef;
    /**
     * references to products that can include the fares
     * 
     */
    @JsonProperty("products")
    @JsonPropertyDescription("references to products that can include the fares")
     ...
     */
    @JsonProperty("defaultRegulatoryConditions")
    public List<String> getDefaultRegulatoryConditions() {
     ...
     */
    @JsonProperty("defaultRegulatoryConditions")
    public void setDefaultRegulatoryConditions(List<String> defaultRegulatoryConditions) {
        this.defaultRegulatoryConditions = defaultRegulatoryConditions;
    }

    @JsonProperty("defaultLuggageConstraintRef")
    public String getDefaultLuggageConstraintRef() {
        return defaultLuggageConstraintRef;
    }

    @JsonProperty("defaultLuggageConstraintRef")
    public void setDefaultLuggageConstraintRef(String defaultLuggageConstraintRef) {
        this.defaultLuggageConstraintRef = defaultLuggageConstraintRef;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("defaultLuggageConstraintRef");
        sb.append('=');
        sb.append(((this.defaultLuggageConstraintRef == null)?"<null>":this.defaultLuggageConstraintRef));
        sb.append(',');
        sb.append("products");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.defaultLuggageConstraintRef == null)? 0 :this.defaultLuggageConstraintRef.hashCode()));
