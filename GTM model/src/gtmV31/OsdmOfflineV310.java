...
public class OsdmOfflineV310 {
    ...
    public String toString() {
        ...
        sb.append(OsdmOfflineV310 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OsdmOfflineV310) == false) {
            return false;
        }
        OsdmOfflineV310 rhs = ((OsdmOfflineV310) other);
