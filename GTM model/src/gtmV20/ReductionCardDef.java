...
public class ReductionCardDef {
    ...
    private List<gtmV20.ServiceClassDefinitionDef.ServiceClassIdDef> serviceClasses = new ArrayList<gtmV20.ServiceClassDefinitionDef.ServiceClassIdDef>();
    /**
     ...
     */
    @JsonProperty("serviceClasses")
    public List<gtmV20.ServiceClassDefinitionDef.ServiceClassIdDef> getServiceClasses() {
     ...
     */
    @JsonProperty("serviceClasses")
    public void setServiceClasses(List<gtmV20.ServiceClassDefinitionDef.ServiceClassIdDef> serviceClasses) {
