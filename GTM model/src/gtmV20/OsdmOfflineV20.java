...
public class OsdmOfflineV20 {
    ...
    public String toString() {
        ...
        sb.append(OsdmOfflineV20 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OsdmOfflineV20) == false) {
            return false;
        }
        OsdmOfflineV20 rhs = ((OsdmOfflineV20) other);
