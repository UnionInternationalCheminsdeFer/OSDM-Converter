...
public class FareDef {
    ...
    private gtmV20.FareConstraintBundle.FareTypeDef fareType;
    /**
     ...
     */
    @JsonProperty("fareType")
    public gtmV20.FareConstraintBundle.FareTypeDef getFareType() {
        return fareType;
    }
     ...
     */
    @JsonProperty("fareType")
    public void setFareType(gtmV20.FareConstraintBundle.FareTypeDef fareType) {
