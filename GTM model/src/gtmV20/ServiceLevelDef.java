...
public class ServiceLevelDef {
    ...
    private List<gtmV20.ServiceClassDefinitionDef.ServiceClassIdDef> combiningServiceClassIds = new ArrayList<gtmV20.ServiceClassDefinitionDef.ServiceClassIdDef>();
    /**
     ...
     */
    @JsonProperty("combiningServiceClassIds")
    public List<gtmV20.ServiceClassDefinitionDef.ServiceClassIdDef> getCombiningServiceClassIds() {
     ...
     */
    @JsonProperty("combiningServiceClassIds")
    public void setCombiningServiceClassIds(List<gtmV20.ServiceClassDefinitionDef.ServiceClassIdDef> combiningServiceClassIds) {
