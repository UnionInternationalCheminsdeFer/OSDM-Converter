...
public class FareDef {
    ...
    private gtmV30.FareConstraintBundle.FareTypeDef fareType;
    /**
     ...
     */
    @JsonProperty("fareType")
    public gtmV30.FareConstraintBundle.FareTypeDef getFareType() {
        return fareType;
    }
     ...
     */
    @JsonProperty("fareType")
    public void setFareType(gtmV30.FareConstraintBundle.FareTypeDef fareType) {
