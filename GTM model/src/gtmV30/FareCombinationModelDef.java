...
public class FareCombinationModelDef {
    ...
    /**
     * List of allowed distrubutors. If the list is empty all distrubutors with a sales contract are allowed.
     * 
     */
    @JsonProperty("allowedDistributors")
    @JsonPropertyDescription("List of allowed distrubutors. If the list is empty all distrubutors with a sales contract are allowed.")
    private List<String> allowedDistributors = new ArrayList<String>();
    /**
     ...
     */
    @JsonProperty("allowedDistributors")
    public List<String> getAllowedDistributors() {
        return allowedDistributors;
    }
     ...
     */
    @JsonProperty("allowedDistributors")
    public void setAllowedDistributors(List<String> allowedDistributors) {
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("allowedDistributors");
        sb.append('=');
        sb.append(((this.allowedDistributors == null)?"<null>":this.allowedDistributors));
        sb.append(',');
    ...
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((this.allowedDistributors == null)? 0 :this.allowedDistributors.hashCode()));
