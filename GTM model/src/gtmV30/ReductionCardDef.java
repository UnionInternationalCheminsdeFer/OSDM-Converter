...
public class ReductionCardDef {
    ...
    private List<gtmV30.ServiceClassDefinitionDef.ServiceClassIdDef> serviceClasses = new ArrayList<gtmV30.ServiceClassDefinitionDef.ServiceClassIdDef>();
    /**
     ...
     */
    @JsonProperty("serviceClasses")
    public List<gtmV30.ServiceClassDefinitionDef.ServiceClassIdDef> getServiceClasses() {
     ...
     */
    @JsonProperty("serviceClasses")
    public void setServiceClasses(List<gtmV30.ServiceClassDefinitionDef.ServiceClassIdDef> serviceClasses) {
