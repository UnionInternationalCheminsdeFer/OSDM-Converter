...
public class ServiceLevelDef {
    ...
    private List<gtmV35.ServiceClassDefinitionDef.ServiceClassIdDef> combiningServiceClassIds = new ArrayList<gtmV35.ServiceClassDefinitionDef.ServiceClassIdDef>();
    /**
     ...
     */
    @JsonProperty("combiningServiceClassIds")
    public List<gtmV35.ServiceClassDefinitionDef.ServiceClassIdDef> getCombiningServiceClassIds() {
     ...
     */
    @JsonProperty("combiningServiceClassIds")
    public void setCombiningServiceClassIds(List<gtmV35.ServiceClassDefinitionDef.ServiceClassIdDef> combiningServiceClassIds) {
