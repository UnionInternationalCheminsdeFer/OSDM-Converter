...
public class OsdmOfflineV350 {
    ...
    public String toString() {
        ...
        sb.append(OsdmOfflineV350 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OsdmOfflineV350) == false) {
            return false;
        }
        OsdmOfflineV350 rhs = ((OsdmOfflineV350) other);
