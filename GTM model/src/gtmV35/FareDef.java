...
public class FareDef {
    ...
    private gtmV35.FareConstraintBundle.FareTypeDef fareType;
    /**
    ...
    private List<String> regulatoryConditions = new ArrayList<String>();
    ...
    /**
     * options for legacy conversion to B.1: NO ( no conversion) YES (conversion allowed), ONLY (fare is provided only for conversion and should not be used otherwise 
     * 
     */
    @JsonProperty("legacyConversion")
    @JsonPropertyDescription("options for legacy conversion to B.1: NO ( no conversion) YES (conversion allowed), ONLY (fare is provided only for conversion and should not be used otherwise ")
    ...
    /**
     * ticket controling organizations involved in the control. Used to provide TCOs access to the ticket in the contraol data (IRS 90918-4)
     * 
     */
    @JsonProperty("involvedTCOs")
    @JsonPropertyDescription("ticket controling organizations involved in the control. Used to provide TCOs access to the ticket in the contraol data (IRS 90918-4)")
    private List<String> involvedTCOs = new ArrayList<String>();
    /**
     * constraints on luggage. Eigther free included luggage in a fare for persons of restrictions on the luggage itself on a fare for luggage
     * 
     */
    @JsonProperty("luggageConstraintRef")
    @JsonPropertyDescription("constraints on luggage. Eigther free included luggage in a fare for persons of restrictions on the luggage itself on a fare for luggage")
    private String luggageConstraintRef;
     ...
     */
    @JsonProperty("fareType")
    public gtmV35.FareConstraintBundle.FareTypeDef getFareType() {
        return fareType;
    }
     ...
     */
    @JsonProperty("fareType")
    public void setFareType(gtmV35.FareConstraintBundle.FareTypeDef fareType) {
     ...
     */
    @JsonProperty("regulatoryConditions")
    public List<String> getRegulatoryConditions() {
     ...
     */
    @JsonProperty("regulatoryConditions")
    public void setRegulatoryConditions(List<String> regulatoryConditions) {
     ...
     */
    @JsonProperty("luggageConstraintRef")
    public String getLuggageConstraintRef() {
        return luggageConstraintRef;
    }
     ...
     */
    @JsonProperty("luggageConstraintRef")
    public void setLuggageConstraintRef(String luggageConstraintRef) {
        this.luggageConstraintRef = luggageConstraintRef;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("luggageConstraintRef");
        sb.append('=');
        sb.append(((this.luggageConstraintRef == null)?"<null>":this.luggageConstraintRef));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.luggageConstraintRef == null)? 0 :this.luggageConstraintRef.hashCode()));
