...
public class ReductionCardDef {
    ...
    private List<gtmV14.ServiceClassDefinitionDef.ServiceClassIdDef> serviceClasses = new ArrayList<gtmV14.ServiceClassDefinitionDef.ServiceClassIdDef>();
    /**
     ...
     */
    @JsonProperty("serviceClasses")
    public List<gtmV14.ServiceClassDefinitionDef.ServiceClassIdDef> getServiceClasses() {
     ...
     */
    @JsonProperty("serviceClasses")
    public void setServiceClasses(List<gtmV14.ServiceClassDefinitionDef.ServiceClassIdDef> serviceClasses) {
