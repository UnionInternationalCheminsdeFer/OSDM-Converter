...
public class ServiceLevelDef {
    ...
    private List<gtmV14.ServiceClassDefinitionDef.ServiceClassIdDef> combiningServiceClassIds = new ArrayList<gtmV14.ServiceClassDefinitionDef.ServiceClassIdDef>();
    /**
     ...
     */
    @JsonProperty("combiningServiceClassIds")
    public List<gtmV14.ServiceClassDefinitionDef.ServiceClassIdDef> getCombiningServiceClassIds() {
     ...
     */
    @JsonProperty("combiningServiceClassIds")
    public void setCombiningServiceClassIds(List<gtmV14.ServiceClassDefinitionDef.ServiceClassIdDef> combiningServiceClassIds) {
