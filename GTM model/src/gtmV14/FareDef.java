...
public class FareDef {
    ...
    private gtmV14.FareConstraintBundle.FareTypeDef fareType;
    /**
     ...
     */
    @JsonProperty("fareType")
    public gtmV14.FareConstraintBundle.FareTypeDef getFareType() {
        return fareType;
    }
     ...
     */
    @JsonProperty("fareType")
    public void setFareType(gtmV14.FareConstraintBundle.FareTypeDef fareType) {
