...
public class OffLineOsdm14 {
    ...
    public String toString() {
        ...
        sb.append(OffLineOsdm14 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OffLineOsdm14) == false) {
            return false;
        }
        OffLineOsdm14 rhs = ((OffLineOsdm14) other);
