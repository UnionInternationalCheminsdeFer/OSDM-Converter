 ...
 * 
 * <p>Java-Klasse f�r linksInJourneyPattern_RelStructure complex type.
 * 
...
public class LinksInJourneyPatternRelStructure
    extends StrictContainmentAggregationStructure
{

    @XmlElements({
        @XmlElement(name = "ServiceLinkInJourneyPattern", type = ServiceLinkInJourneyPattern.class),
        @XmlElement(name = "TimingLinkInJourneyPattern", type = TimingLinkInJourneyPattern.class)
    })
    protected List<LinkInLinkSequenceVersionedChildStructure> serviceLinkInJourneyPatternOrTimingLinkInJourneyPattern;
     ...
     * 
     */
    public List<LinkInLinkSequenceVersionedChildStructure> getServiceLinkInJourneyPatternOrTimingLinkInJourneyPattern() {
        if (serviceLinkInJourneyPatternOrTimingLinkInJourneyPattern == null) {
            serviceLinkInJourneyPatternOrTimingLinkInJourneyPattern = new ArrayList<LinkInLinkSequenceVersionedChildStructure>();
        }
