 ...
 * 
 * <p>Java-Klasse f�r farePrices_RelStructure complex type.
 * 
...
@XmlType(name = "farePrices_RelStructure", propOrder = {
    "farePriceRefOrCellRefDummyOrFarePriceDummy"
})
public class FarePricesRelStructure
    extends StrictContainmentAggregationStructure
{
    ...
    protected List<JAXBElement<?>> farePriceRefOrCellRefDummyOrFarePriceDummy;

    /**
     * Gets the value of the farePriceRefOrCellRefDummyOrFarePriceDummy property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the farePriceRefOrCellRefDummyOrFarePriceDummy property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFarePriceRefOrCellRefDummyOrFarePriceDummy().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getFarePriceRefOrCellRefDummyOrFarePriceDummy() {
        if (farePriceRefOrCellRefDummyOrFarePriceDummy == null) {
            farePriceRefOrCellRefDummyOrFarePriceDummy = new ArrayList<JAXBElement<?>>();
        }
        return this.farePriceRefOrCellRefDummyOrFarePriceDummy;
    }
