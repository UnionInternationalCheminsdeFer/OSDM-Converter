 ...
 * 
 * <p>Java-Klasse f�r OperatingDay_DerivedViewStructure complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="OperatingDay_DerivedViewStructure">
 *   &lt;complexContent>
...
@XmlType(name = "OperatingDay_DerivedViewStructure", propOrder = {
    "calendarDate",
    "serviceCalendarRef",
    "name",
    "shortName",
...
@XmlSeeAlso({
    OperatingDayView.class
})
public class OperatingDayDerivedViewStructure
