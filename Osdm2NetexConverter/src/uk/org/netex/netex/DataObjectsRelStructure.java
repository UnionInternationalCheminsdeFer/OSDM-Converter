 ...
 * 
 * <p>Java-Klasse f�r dataObjects_RelStructure complex type.
 * 
...
public class DataObjectsRelStructure {
    ...
    protected List<JAXBElement<? extends CommonVersionFrameStructure>> compositeFrameOrCommonFrame;
     ...
     * 
     */
    public List<JAXBElement<? extends CommonVersionFrameStructure>> getCompositeFrameOrCommonFrame() {
        if (compositeFrameOrCommonFrame == null) {
            compositeFrameOrCommonFrame = new ArrayList<JAXBElement<? extends CommonVersionFrameStructure>>();
        }
