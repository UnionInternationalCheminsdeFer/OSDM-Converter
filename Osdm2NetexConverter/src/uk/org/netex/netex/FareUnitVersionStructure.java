 ...
 * Type for FARE UNIT.
 * 
 * <p>Java-Klasse f�r FareUnit_VersionStructure complex type.
 * 
...
@XmlSeeAlso({
    FareUnit.class,
    TimeUnitVersionStructure.class,
    GeographicalUnitVersionStructure.class
})
public class FareUnitVersionStructure
