 ...
 * 
 * <p>Java-Klasse f�r PassengerBoardingPositionAssignment_VersionStructure complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="PassengerBoardingPositionAssignment_VersionStructure">
 *   &lt;complexContent>
...
@XmlType(name = "PassengerBoardingPositionAssignment_VersionStructure", propOrder = {
...
@XmlSeeAlso({
    PassengerBoardingPositionAssignment.class,
    TrainComponentStopAssignmentVersionStructure.class,
    DeckEntranceAssignmentVersionStructure.class
})
public class PassengerBoardingPositionAssignmentVersionStructure
