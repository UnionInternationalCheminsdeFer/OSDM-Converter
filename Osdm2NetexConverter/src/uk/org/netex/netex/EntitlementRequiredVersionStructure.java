 ...
 * 
 * <p>Java-Klasse f�r EntitlementRequired_VersionStructure complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="EntitlementRequired_VersionStructure">
 *   &lt;complexContent>
...
@XmlType(name = "EntitlementRequired_VersionStructure", propOrder = {
    "serviceAccessRightRef",
    "minimumQualificationPeriod",
    "entitlementConstraint"
})
@XmlSeeAlso({
    EntitlementRequired.class
})
public class EntitlementRequiredVersionStructure
