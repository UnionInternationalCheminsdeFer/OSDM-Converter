 ...
 * 
 * <p>Java-Klasse f�r cells_RelStructure complex type.
 * 
...
@XmlType(name = "cells_RelStructure", propOrder = {
    "cellOrCellInContextOrFarePriceDummy"
})
public class CellsRelStructure
    extends StrictContainmentAggregationStructure
{
    ...
    protected List<JAXBElement<?>> cellOrCellInContextOrFarePriceDummy;

    /**
     * Gets the value of the cellOrCellInContextOrFarePriceDummy property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cellOrCellInContextOrFarePriceDummy property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCellOrCellInContextOrFarePriceDummy().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link CellsRelStructure.CellInContext }{@code >}
     ...
     * 
     */
    public List<JAXBElement<?>> getCellOrCellInContextOrFarePriceDummy() {
        if (cellOrCellInContextOrFarePriceDummy == null) {
            cellOrCellInContextOrFarePriceDummy = new ArrayList<JAXBElement<?>>();
        }
        return this.cellOrCellInContextOrFarePriceDummy;
    }
    ...
    public static class CellInContext
        extends CellVersionedChildStructure
    {
