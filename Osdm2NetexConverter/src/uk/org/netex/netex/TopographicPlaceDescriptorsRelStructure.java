 ...
 * 
 * <p>Java-Klasse f�r topographicPlaceDescriptors_RelStructure complex type.
 * 
...
@XmlSeeAlso({
    uk.org.netex.netex.TopographicPlaceVersionStructure.AlternativeDescriptors.class
})
public class TopographicPlaceDescriptorsRelStructure
    extends StrictContainmentAggregationStructure
{

    @XmlElement(name = "TopographicPlaceDescriptor", required = true)
    protected List<TopographicPlaceDescriptorVersionedChildStructure> topographicPlaceDescriptor;
     ...
     * 
     */
    public List<TopographicPlaceDescriptorVersionedChildStructure> getTopographicPlaceDescriptor() {
        if (topographicPlaceDescriptor == null) {
            topographicPlaceDescriptor = new ArrayList<TopographicPlaceDescriptorVersionedChildStructure>();
        }
