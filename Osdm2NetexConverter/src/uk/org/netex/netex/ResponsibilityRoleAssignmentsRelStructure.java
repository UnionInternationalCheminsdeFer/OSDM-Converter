 ...
 * 
 * <p>Java-Klasse f�r responsibilityRoleAssignments_RelStructure complex type.
 * 
...
public class ResponsibilityRoleAssignmentsRelStructure
    extends StrictContainmentAggregationStructure
{

    @XmlElement(name = "ResponsibilityRoleAssignment", required = true)
    protected List<ResponsibilityRoleAssignment> responsibilityRoleAssignment;
     ...
     * 
     */
    public List<ResponsibilityRoleAssignment> getResponsibilityRoleAssignment() {
        if (responsibilityRoleAssignment == null) {
            responsibilityRoleAssignment = new ArrayList<ResponsibilityRoleAssignment>();
        }
