 ...
 * 
 * <p>Java-Klasse f�r typesOfValue_RelStructure complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="typesOfValue_RelStructure">
 *   &lt;complexContent>
...
@XmlType(name = "typesOfValue_RelStructure", propOrder = {
    "typeOfValue"
})
public class TypesOfValueRelStructure
    extends StrictContainmentAggregationStructure
{

    @XmlElementRef(name = "TypeOfValue", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class)
    protected List<JAXBElement<? extends TypeOfValueVersionStructure>> typeOfValue;
     ...
     * 
     */
    public List<JAXBElement<? extends TypeOfValueVersionStructure>> getTypeOfValue() {
        if (typeOfValue == null) {
            typeOfValue = new ArrayList<JAXBElement<? extends TypeOfValueVersionStructure>>();
        }
