 ...
 * 
 * <p>Java-Klasse f�r entityInVersionInFrame_RelStructure complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="entityInVersionInFrame_RelStructure">
 *   &lt;complexContent>
...
@XmlType(name = "entityInVersionInFrame_RelStructure", propOrder = {
    "versionOfObjectRefOrLinkRefByValue"
})
public class EntityInVersionInFrameRelStructure
    extends ContainmentAggregationStructure
{
    ...
    protected List<JAXBElement<?>> versionOfObjectRefOrLinkRefByValue;

    /**
     * Gets the value of the versionOfObjectRefOrLinkRefByValue property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the versionOfObjectRefOrLinkRefByValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVersionOfObjectRefOrLinkRefByValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getVersionOfObjectRefOrLinkRefByValue() {
        if (versionOfObjectRefOrLinkRefByValue == null) {
            versionOfObjectRefOrLinkRefByValue = new ArrayList<JAXBElement<?>>();
        }
        return this.versionOfObjectRefOrLinkRefByValue;
    }
