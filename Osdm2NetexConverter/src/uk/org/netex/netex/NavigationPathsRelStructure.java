 ...
 * 
 * <p>Java-Klasse f�r navigationPaths_RelStructure complex type.
 * 
...
public class NavigationPathsRelStructure
    extends ContainmentAggregationStructure
{

    @XmlElements({
        @XmlElement(name = "NavigationPathRef", type = SiteNavigationPathRefStructure.class),
