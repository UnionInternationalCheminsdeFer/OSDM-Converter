 ...
 * 
 * <p>Java-Klasse f�r FareRequestRefStructure complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="FareRequestRefStructure">
 *   &lt;simpleContent>
 ...
 *       &lt;attribute name="ref" use="required" type="{http://www.netex.org.uk/netex}FareRequestIdType" />
...
@XmlType(name = "FareRequestRefStructure")
@XmlSeeAlso({
    SingleTripFareRequestRefStructure.class,
    RepeatedTripFareRequestRefStructure.class
})
public class FareRequestRefStructure
