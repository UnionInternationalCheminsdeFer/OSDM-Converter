 ...
 * 
 * <p>Java-Klasse f�r trainsInCompoundTrain_RelStructure complex type.
 * 
...
public class TrainsInCompoundTrainRelStructure
    extends StrictContainmentAggregationStructure
{

    @XmlElement(name = "TrainInCompoundTrain", required = true)
    protected List<TrainInCompoundTrainVersionedChildStructure> trainInCompoundTrain;
     ...
     * {@link TrainInCompoundTrainVersionedChildStructure }
     * 
     * 
     */
    public List<TrainInCompoundTrainVersionedChildStructure> getTrainInCompoundTrain() {
        if (trainInCompoundTrain == null) {
            trainInCompoundTrain = new ArrayList<TrainInCompoundTrainVersionedChildStructure>();
        }
