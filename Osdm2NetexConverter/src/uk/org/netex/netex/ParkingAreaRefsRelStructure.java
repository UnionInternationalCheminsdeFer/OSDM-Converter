 ...
 * 
 * <p>Java-Klasse f�r parkingAreaRefs_RelStructure complex type.
 * 
...
public class ParkingAreaRefsRelStructure
    extends OneToManyRelationshipStructure
{

    @XmlElementRef(name = "ParkingAreaRef", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class)
    protected List<JAXBElement<? extends ParkingAreaRefStructure>> parkingAreaRef;
     ...
     * 
     */
    public List<JAXBElement<? extends ParkingAreaRefStructure>> getParkingAreaRef() {
        if (parkingAreaRef == null) {
            parkingAreaRef = new ArrayList<JAXBElement<? extends ParkingAreaRefStructure>>();
        }
