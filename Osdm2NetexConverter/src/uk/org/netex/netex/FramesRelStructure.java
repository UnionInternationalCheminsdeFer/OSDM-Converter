 ...
 * 
 * <p>Java-Klasse f�r frames_RelStructure complex type.
 * 
...
public class FramesRelStructure
    extends ContainmentAggregationStructure
{

    @XmlElementRef(name = "CommonFrame", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class)
    protected List<JAXBElement<? extends CommonVersionFrameStructure>> commonFrame;
     ...
     * 
     */
    public List<JAXBElement<? extends CommonVersionFrameStructure>> getCommonFrame() {
        if (commonFrame == null) {
            commonFrame = new ArrayList<JAXBElement<? extends CommonVersionFrameStructure>>();
        }
