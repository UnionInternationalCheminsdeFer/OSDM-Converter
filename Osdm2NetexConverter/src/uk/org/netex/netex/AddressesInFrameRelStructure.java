 ...
 * 
 * <p>Java-Klasse f�r addressesInFrame_RelStructure complex type.
 * 
...
public class AddressesInFrameRelStructure
    extends ContainmentAggregationStructure
{

    @XmlElementRef(name = "Address", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class)
    protected List<JAXBElement<? extends AddressVersionStructure>> address;
     ...
     * 
     */
    public List<JAXBElement<? extends AddressVersionStructure>> getAddress() {
        if (address == null) {
            address = new ArrayList<JAXBElement<? extends AddressVersionStructure>>();
        }
        return this.address;
    }
