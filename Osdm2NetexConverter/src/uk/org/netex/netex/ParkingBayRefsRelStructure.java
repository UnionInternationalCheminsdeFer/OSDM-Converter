 ...
 * 
 * <p>Java-Klasse f�r parkingBayRefs_RelStructure complex type.
 * 
...
public class ParkingBayRefsRelStructure
    extends OneToManyRelationshipStructure
{

    @XmlElementRef(name = "ParkingBayRef", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class)
    protected List<JAXBElement<? extends ParkingBayRefStructure>> parkingBayRef;
     ...
     * 
     */
    public List<JAXBElement<? extends ParkingBayRefStructure>> getParkingBayRef() {
        if (parkingBayRef == null) {
            parkingBayRef = new ArrayList<JAXBElement<? extends ParkingBayRefStructure>>();
        }
