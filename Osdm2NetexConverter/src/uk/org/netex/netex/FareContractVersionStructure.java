 ...
 * 
 * <p>Java-Klasse f�r FareContract_VersionStructure complex type.
 * 
...
public class FareContractVersionStructure
    extends DataManagedObjectStructure
{

    @XmlElementRefs({
        @XmlElementRef(name = "CustomerAccountRef", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "CustomerRef", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "fareContractEntries", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Description", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "TypeOfFareContractRef", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class, required = false)
    })
     ...
     * Zeile 403 von file:/D:/eclipse-wsp3/NeTex/schema/xsd/netex_part_3/part3_salesTransactions/netex_salesContract_version.xsd
     ...
     * {@link JAXBElement }{@code <}{@link FareContractEntriesRelStructure }{@code >}
     * {@link JAXBElement }{@code <}{@link MultilingualString }{@code >}
