 ...
 * 
 * <p>Java-Klasse f�r accessRightParameterAssignmentsInFrame_RelStructure complex type.
 * 
...
public class AccessRightParameterAssignmentsInFrameRelStructure
    extends FrameContainmentStructure
{

    @XmlElementRef(name = "AccessRightParameterAssignment_Dummy", namespace = "http://www.netex.org.uk/netex", type = JAXBElement.class, required = false)
    protected List<JAXBElement<? extends DataManagedObjectStructure>> accessRightParameterAssignmentDummy;

    /**
     * Gets the value of the accessRightParameterAssignmentDummy property.
     * 
     * <p>
