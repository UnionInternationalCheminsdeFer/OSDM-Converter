 ...
 * 
 * <p>Java-Klasse f�r infrastructureJunctionsInFrame_RelStructure complex type.
 * 
...
public class InfrastructureJunctionsInFrameRelStructure
    extends ContainmentAggregationStructure
{
    ...
    protected List<InfrastructurePointVersionStructure> railwayJunctionOrRoadJunctionOrWireJunction;
     ...
     * 
     */
    public List<InfrastructurePointVersionStructure> getRailwayJunctionOrRoadJunctionOrWireJunction() {
        if (railwayJunctionOrRoadJunctionOrWireJunction == null) {
            railwayJunctionOrRoadJunctionOrWireJunction = new ArrayList<InfrastructurePointVersionStructure>();
        }
