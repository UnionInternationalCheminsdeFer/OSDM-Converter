 ...
 * 
 * <p>Java-Klasse f�r fareScheduledStopPointsInFrame_RelStructure complex type.
 * 
...
public class FareScheduledStopPointsInFrameRelStructure
    extends FrameContainmentStructure
{
    ...
    protected List<ScheduledStopPointVersionStructure> scheduledStopPointOrFareScheduledStopPoint;
     ...
     * 
     */
    public List<ScheduledStopPointVersionStructure> getScheduledStopPointOrFareScheduledStopPoint() {
        if (scheduledStopPointOrFareScheduledStopPoint == null) {
            scheduledStopPointOrFareScheduledStopPoint = new ArrayList<ScheduledStopPointVersionStructure>();
        }
