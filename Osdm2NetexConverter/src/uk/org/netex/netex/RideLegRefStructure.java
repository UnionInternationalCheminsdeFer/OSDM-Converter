 ...
 * 
 * <p>Java-Klasse f�r RideLegRefStructure complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="RideLegRefStructure">
 *   &lt;simpleContent>
...
@XmlType(name = "RideLegRefStructure")
@XmlSeeAlso({
    AlternativeModeLegRefStructure.class,
    PtRideLegRefStructure.class
})
public class RideLegRefStructure
