 ...
 * 
 * <p>Java-Klasse f�r ThirdPartyProduct_VersionStructure complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="ThirdPartyProduct_VersionStructure">
 *   &lt;complexContent>
...
@XmlType(name = "ThirdPartyProduct_VersionStructure", propOrder = {
    "generalGroupOfEntitiesRef",
    "generalGroupOfEntities"
})
@XmlSeeAlso({
    ThirdPartyProduct.class
})
public class ThirdPartyProductVersionStructure
