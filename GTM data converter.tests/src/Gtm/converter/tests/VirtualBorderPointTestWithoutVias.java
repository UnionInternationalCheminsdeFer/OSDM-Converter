...
public class VirtualBorderPointTestWithoutVias {
...
//		gtmUtilsMock = Mockito.mock(GtmUtils.class);				
	...
	public void testVirtualNonMeritsBorderStationConversion() {
		...
		for (RegionalConstraint r : tool.getGeneralTariffModel().getFareStructure().getRegionalConstraints().getRegionalConstraints()) {
			...
			if (isReturnRoute) {
				assert(description.equals("G*A"));
			} else {
				assert(description.equals("A*G"));
			}
		}
		...
		assert(s.getRouteDescription() == null || s.getRouteDescription().equals(""));
