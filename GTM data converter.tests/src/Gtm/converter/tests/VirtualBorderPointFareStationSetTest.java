...
public class VirtualBorderPointFareStationSetTest {
	...
	@Test 
	public void testVirtualNonMeritsFareStationSetBorderStationConversion() {
		...
		assert(tool.getGeneralTariffModel().getFareStructure().getConnectionPoints().getConnectionPoints().size() == 3);
