...
public class StationSetStartEndBorderConversionTest {

	
	int borderPointCode = 123;
	int legacyBorderStationCode = 100;
...
//		MockitoAnnotations.initMocks(this);
		...
		borderPointCode = 123;
		legacyBorderStationCode = 100;
		
		tool.getConversionFromLegacy().getLegacy108().setLegacyStations(GtmFactory.eINSTANCE.createLegacy108Stations());;
		LegacyDataFactory.addLegacyStation(tool,1,"A-Stadt","A-Stadt","A", 0,legacyBorderStationCode);
		LegacyDataFactory.addLegacyStation(tool,legacyBorderStationCode,"A-Area","A-area","A-ar", borderPointCode,legacyBorderStationCode);
		LegacyDataFactory.addLegacyStation(tool,2,"B-Stadt","B-Stadt","B", 0,legacyBorderStationCode);
		LegacyDataFactory.addLegacyStation(tool,7,"G-Stadt","G-Stadt","G", 0,900);
		LegacyDataFactory.addLegacyStation(tool,8,"H-Main","H-Main","H", 1,900);
		LegacyDataFactory.addLegacyStation(tool,900,"H-Stadt","H-area","H-ar", 1,900);
