...
public class MemoMultiLIneConversionTest {
	...
	public void initialize() {
		...
		memo.setFrench("FrenchFrenchFrenchFrench"+'\n'+"French2French2French2French2French2");
		memo.setLocal("LocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocal");
	...
	public void testMemoConversion() {
		...
		assert(memo.getLocal().equals("LocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocalLocal"));
		assert(memo.getFrench().equals("FrenchFrenchFrenchFrench"+'\n'+"French2French2French2French2French2"));
