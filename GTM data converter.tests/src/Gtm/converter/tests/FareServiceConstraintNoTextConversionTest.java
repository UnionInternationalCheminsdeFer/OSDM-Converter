...
public class FareServiceConstraintNoTextConversionTest {
	...
	public void testFareServiceConstraintConversion() {
		...
		assert(fd.getDescriptionLocal().equals("Standard,ship"));
		assert(fd.getDescriptionGe().equals("ship"));
		assert(fd.getDescriptionFr().equals("ship"));
		assert(fd.getDescriptionEn().equals("ship"));
