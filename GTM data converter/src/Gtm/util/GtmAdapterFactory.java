...
public class GtmAdapterFactory extends AdapterFactoryImpl {
	...
	protected GtmSwitch<Adapter> modelSwitch =
		new GtmSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMaximalPrice(MaximalPrice object) {
				return createMaximalPriceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Gtm.MaximalPrice <em>Maximal Price</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
