 ...
 *   <li>{@link Gtm.impl.LegacyDistanceFareImpl#getReturnFare1st <em>Return Fare1st</em>}</li>
 *   <li>{@link Gtm.impl.LegacyDistanceFareImpl#getReturnFare2nd <em>Return Fare2nd</em>}</li>
 *   <li>{@link Gtm.impl.LegacyDistanceFareImpl#getValidFrom <em>Valid From</em>}</li>
 *   <li>{@link Gtm.impl.LegacyDistanceFareImpl#getValidUntil <em>Valid Until</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LegacyDistanceFareImpl extends MinimalEObjectImpl.Container implements LegacyDistanceFare {
	...
	public void setReturnFare1st(int newReturnFare1st) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GtmPackage.LEGACY_DISTANCE_FARE__RETURN_FARE1ST, oldReturnFare1st, returnFare1st));
	}
	...
	public void setReturnFare2nd(int newReturnFare2nd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GtmPackage.LEGACY_DISTANCE_FARE__RETURN_FARE2ND, oldReturnFare2nd, returnFare2nd));
	}
	...
	public void setValidFrom(Date newValidFrom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GtmPackage.LEGACY_DISTANCE_FARE__VALID_FROM, oldValidFrom, validFrom));
	}
	...
	public void setValidUntil(Date newValidUntil) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GtmPackage.LEGACY_DISTANCE_FARE__VALID_UNTIL, oldValidUntil, validUntil));
	}
