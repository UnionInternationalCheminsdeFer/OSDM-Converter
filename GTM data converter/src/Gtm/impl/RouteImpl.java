 ...
 * </p>
 * <ul>
 *   <li>{@link Gtm.impl.RouteImpl#getStations <em>Stations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RouteImpl extends MinimalEObjectImpl.Container implements Route {
	...
	protected EClass eStaticClass() {
		return GtmPackage.Literals.ROUTE;
	}
	...
	public EList<ViaStation> getStations() {
		if (stations == null) {
			stations = new EObjectContainmentEList<ViaStation>(ViaStation.class, this, GtmPackage.ROUTE__STATIONS);
		}
		return stations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GtmPackage.ROUTE__STATIONS:
