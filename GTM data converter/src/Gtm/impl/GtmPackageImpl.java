...
public class GtmPackageImpl extends EPackageImpl implements GtmPackage {
	 ...
	 * @generated
	 */
	private EClass vatTemplateEClass = null;
	 ...
	 * @generated
	 */
	private EClass minimalPriceEClass = null;
	 ...
	 * @generated
	 */
	private EClass legacy108MemosEClass = null;
	 ...
	 * @generated
	 */
	private EClass legacy108MemoEClass = null;
	...
	public EAttribute getServiceBrand_LocalLanguageName() {
		return (EAttribute)serviceBrandEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getServiceConstraint_Legacy108Code() {
		return (EAttribute)serviceConstraintEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getConversionParams_VatTemplates() {
		return (EReference)conversionParamsEClass.getEStructuralFeatures().get(14);
	}
	 ...
	 * @generated
	 */
	public EReference getVatTemplates_VatTemplates() {
		return (EReference)vatTemplatesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getVatTemplate() {
		return vatTemplateEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getVatTemplate_Scope() {
		return (EAttribute)vatTemplateEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getVatTemplate_Country() {
		return (EReference)vatTemplateEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getVatTemplate_Percentage() {
		return (EAttribute)vatTemplateEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getVatTemplate_TaxId() {
		return (EAttribute)vatTemplateEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getFareTemplate_MinimalPrice() {
		return (EReference)fareTemplateEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getMinimalPrice() {
		return minimalPriceEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAfterSalesTemplate_RoundingMode() {
		return (EAttribute)afterSalesTemplateEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getLegacy108_LegacyMemos() {
		return (EReference)legacy108EClass.getEStructuralFeatures().get(12);
	}
	 ...
	 * @generated
	 */
	public EReference getLegacy108Memos_LegacyMemos() {
		return (EReference)legacy108MemosEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getLegacy108Memo() {
		return legacy108MemoEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getLegacy108Memo_Number() {
		return (EAttribute)legacy108MemoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLegacy108Memo_Local() {
		return (EAttribute)legacy108MemoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLegacy108Memo_English() {
		return (EAttribute)legacy108MemoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLegacy108Memo_French() {
		return (EAttribute)legacy108MemoEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLegacy108Memo_German() {
		return (EAttribute)legacy108MemoEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(serviceBrandEClass, SERVICE_BRAND__LOCAL_LANGUAGE_NAME);
		...
		createEAttribute(countryEClass, COUNTRY__DEFAULT_CHARACTER_SET);
		...
		createEAttribute(textEClass, TEXT__DATA_SOURCE);
		...
		vatTemplateEClass = createEClass(VAT_TEMPLATE);
		createEAttribute(vatTemplateEClass, VAT_TEMPLATE__SCOPE);
		createEReference(vatTemplateEClass, VAT_TEMPLATE__COUNTRY);
		createEAttribute(vatTemplateEClass, VAT_TEMPLATE__PERCENTAGE);
		createEAttribute(vatTemplateEClass, VAT_TEMPLATE__TAX_ID);
		...
		createEAttribute(afterSalesTemplateEClass, AFTER_SALES_TEMPLATE__ROUNDING_MODE);
		...
		legacy108MemoEClass = createEClass(LEGACY108_MEMO);
		createEAttribute(legacy108MemoEClass, LEGACY108_MEMO__NUMBER);
		createEAttribute(legacy108MemoEClass, LEGACY108_MEMO__LOCAL);
		createEAttribute(legacy108MemoEClass, LEGACY108_MEMO__ENGLISH);
		createEAttribute(legacy108MemoEClass, LEGACY108_MEMO__FRENCH);
		createEAttribute(legacy108MemoEClass, LEGACY108_MEMO__GERMAN);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getServiceBrand_LocalLanguageName(), ecorePackage.getEString(), "localLanguageName", null, 0, 1, ServiceBrand.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCountry_DefaultCharacterSet(), this.getCharacterSet(), "defaultCharacterSet", null, 0, 1, Country.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFareConstraintBundle_DefaultFareType(), this.getFareType(), "defaultFareType", "NRT", 0, 1, FareConstraintBundle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getText_DataSource(), this.getDataSource(), "dataSource", null, 0, 1, Text.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(vatTemplateEClass, VatTemplate.class, "VatTemplate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVatTemplate_Scope(), this.getTaxScope(), "scope", null, 0, 1, VatTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVatTemplate_Country(), this.getCountry(), null, "country", null, 0, 1, VatTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVatTemplate_Percentage(), ecorePackage.getEFloat(), "percentage", null, 0, 1, VatTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVatTemplate_TaxId(), ecorePackage.getEString(), "taxId", null, 0, 1, VatTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAfterSalesTemplate_RoundingMode(), this.getRoundingType(), "roundingMode", null, 0, 1, AfterSalesTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(legacy108MemoEClass, Legacy108Memo.class, "Legacy108Memo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLegacy108Memo_Number(), ecorePackage.getEInt(), "number", null, 0, 1, Legacy108Memo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLegacy108Memo_Local(), ecorePackage.getEString(), "local", null, 0, 1, Legacy108Memo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLegacy108Memo_English(), ecorePackage.getEString(), "english", null, 0, 1, Legacy108Memo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLegacy108Memo_French(), ecorePackage.getEString(), "french", null, 0, 1, Legacy108Memo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLegacy108Memo_German(), ecorePackage.getEString(), "german", null, 0, 1, Legacy108Memo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(characterSetEEnum, CharacterSet.LATINGREEK_ISO88597);
		...
		addEEnumLiteral(characterSetEEnum, CharacterSet.LATIN3_ISO88593);
		...
		addEEnumLiteral(roundingTypeEEnum, RoundingType.UP5CENT);
		...
		addEEnumLiteral(taxScopeEEnum, TaxScope.INTERNATIONAL);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (reductionCardEClass,
		   source,
		   new String[] {
			   "constraints", "ISUER_MUST_FOR_NON_GENERIC NOT_REFERENCED CARD_ID_FORMAT"
		   });
		addAnnotation
