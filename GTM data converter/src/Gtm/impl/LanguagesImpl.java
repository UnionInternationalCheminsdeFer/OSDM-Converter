 ...
 * </p>
 * <ul>
 *   <li>{@link Gtm.impl.LanguagesImpl#getLanguages <em>Languages</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LanguagesImpl extends MinimalEObjectImpl.Container implements Languages {
	/**
	...
	protected EClass eStaticClass() {
		return GtmPackage.Literals.LANGUAGES;
	}
	...
	public EList<Language> getLanguages() {
		if (languages == null) {
			languages = new EObjectContainmentEList<Language>(Language.class, this, GtmPackage.LANGUAGES__LANGUAGES);
		}
		return languages;
	}
